...
* `preproc/`: all the scripts for preprocessing (e.g., flow identification, insertion of extra information by decoding LoRa headers, etc.)
* `tools/`: auxiliary scripts used elsewhere (e.g., LoRa decoding, elastic search queries, etc.)
